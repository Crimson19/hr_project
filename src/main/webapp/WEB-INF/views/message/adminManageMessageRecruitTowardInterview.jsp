...
<head>
    ...
    <script>
        function del(trIndex,messageId) {
            ...
            $.ajax({
                url:"message/adminSendInterview.do",
                data:{"messageContent":content,"messageTargetId":targetId},
                success:function (data) {
                    alert(data);
                }
            });
                ...
                <c:forEach items="${messageList}" var="message">
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-success" id="interviewMessage" onclick="interview(${message.senderId},${message.messageContent})">通知面试</button>
                        </td>
                    </tr>
                </c:forEach>
            </table>
